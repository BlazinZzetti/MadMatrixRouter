...
public class ACPointEditor : Editor
{
    private ACPoint point;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (point != null)
        {
            ...
            if (point.Type == ACPoint.PointType.PathPoint)
            {
    ...
    private void createPoint()
    {
        if (point != null)
        {
            ...
            var newPath = newPathObject.GetComponent<ACPath>();
            var newPoint = newPointObject.GetComponent<ACPoint>();
